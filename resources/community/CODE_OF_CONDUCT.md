...
When an incident does occur, it is important to report it promptly. To report a possible violation, please [raise an issue on the Github repository](https://github.com/edesz/dbt_prefect_duckdb_starter/issues).
